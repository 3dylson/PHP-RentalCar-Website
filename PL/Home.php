...
<br>
        <input href="../index.php?page=EscolherVeiculo" type="submit" name="Reservar" value="Pesquisar" class="btn btn-primary btn-lg active" role="button" aria-pressed="true"></input>
