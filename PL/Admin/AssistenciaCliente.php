                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="container">
                            ...
                            <p>Clientes diponíveis para chat:</p>
                    ...
                    <div class="col-sm-6">
                        <div class="card-" style="width: 18rem;">
                            <div class="card-body">
                                <h5 class="card-title">Pedro Tavares</h5>
                                <h6 class="card-subtitle mb-2 text-muted">Reserva R123</h6>
                    ...
                    <div class="col-sm-4" id="Chatnprofile">
                        <div class="container">
                            <div class="row">
                                <div class="col-md-3">
                            ...
                            <img src="http://placehold.it/50/55C1E7/fff&text=U" alt="User Avatar" class="img-circle" />
                                                    ...
                                                    <div class="chat-body clearfix">
                                                        <div class="header">
                                                            <strong class="primary-font">Pedro Tavares</strong>
                                                            <small class="pull-right text-muted">
                                                            <span class="glyphicon glyphicon-time">

                                                            </span>12 mins ago</small>
                                                        </div>
                                                        <p>
                                                    ...
                                                    <div class="chat-body clearfix">
                                                        <div class="header">
                                                            <small class=" text-muted">
                                                                <span class="glyphicon glyphicon-time">
                                                                </span>13 mins ago</small>
                                                            <strong class="pull-right primary-font">Edylson F.</strong>
                                                        </div>
                                                        <p>
                                                            Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                                                            Curabitur bibendum ornare
                            ...
                            <img src="http://placehold.it/50/FA6F57/fff&text=ME" alt="User Avatar" class="img-circle" />
                                                    ...
                                                    <div class="chat-body clearfix">
                                                        <div class="header">
                                                            ...
                                                            glyphicon-time"></span>15 mins ago</small>
                                                            <strong class="pull-right primary-font">Edylson F.</strong>
                                                        </div>
                                                        <p>
                                                            Lorem ipsum dolor sit amet, consectetur adipiscing elit.
